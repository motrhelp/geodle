export const countryList = [
    ...
    { code: "DZ", name: "Algeria", lat: 28.033886, lon: 1.659626, flag: require("../img/Flag_of_Algeria.png"), emoji: "🇩🇿", capital: { name: "Algiers" } },
    ...
    { code: "AD", name: "Andorra", lat: 42.546245, lon: 1.601554, flag: require("../img/Flag_of_Andorra.svg.png"), emoji: "🇦🇩", capital: { name: "Andorra la Vella" } },
    { code: "AO", name: "Angola", lat: -11.202692, lon: 17.873887, flag: require("../img/Flag_of_Angola.png"), capital: { name: "Luanda" } },
    ...
    { code: "AG", name: "Antigua and Barbuda", lat: 17.060816, lon: -61.796428, flag: require("../img/Flag_of_Antigua_and_Barbuda.svg.png"), capital: { name: "Saint John's" } },
    { code: "AR", name: "Argentina", lat: -38.416097, lon: -63.616672, flag: require("../img/Flag_of_Argentina.png"), capital: { name: "Buenos Aires" } },
    ...
    { code: "AW", name: "Aruba", lat: 12.52111, lon: -69.968338, flag: require("../img/Flag_of_Aruba.svg.png"), capital: { name: "Oranjestad" } },
    { code: "AU", name: "Australia", lat: -25.274398, lon: 133.775136, flag: require("../img/Flag_of_Australia_(converted).png"), capital: { name: "Canberra" } },
    { code: "AT", name: "Austria", lat: 47.516231, lon: 14.550072, flag: require("../img/Flag_of_Austria.png"), capital: { name: "Vienna" } },
    ...
    { code: "BW", name: "Botswana", lat: -22.328474, lon: 24.684866, flag: require("../img/Flag_of_Botswana.svg.png"), capital: { name: "Gaborone" } },
    { code: "BV", name: "Bouvet Island", lat: -54.423199, lon: 3.413194 },
    { code: "BR", name: "Brazil", lat: -14.235004, lon: -51.92528, flag: require("../img/640px-Flag_of_Brazil.png"), capital: { name: "Brasilia" } },
    { code: "IO", name: "British Indian Ocean Territory", lat: -6.343194, lon: 71.876519 },
    { code: "BN", name: "Brunei", lat: 4.535277, lon: 114.727669, flag: require("../img/Flag_of_Brunei.svg.png"), capital: { name: "Bandar Seri Begawan" } },
    { code: "BG", name: "Bulgaria", lat: 42.733883, lon: 25.48583, flag: require("../img/Flag_of_Bulgaria.png"), capital: { name: "Sofia" } },
    { code: "BF", name: "Burkina Faso", lat: 12.238333, lon: -1.561593, flag: require("../img/Flag_of_Burkina_Faso.svg.png"), capital: { name: "Ouagadougou" } },
    { code: "BI", name: "Burundi", lat: 3.373056, lon: 29.918886, flag: require("../img/Flag_of_Burundi.svg.png"), capital: { name: "Gitega" } },
    { code: "KH", name: "Cambodia", lat: 12.565679, lon: 104.990963, flag: require("../img/640px-Flag_of_Cambodia.svg.png"), capital: { name: "Phnom Penh" } },
    { code: "CM", name: "Cameroon", lat: 7.369722, lon: 12.354722 },
    { code: "CA", name: "Canada", lat: 56.130366, lon: -106.346771, flag: require("../img/Flag_of_Canada.svg.png"), capital: { name: "Ottawa" } },
    { code: "CV", name: "Cape Verde", lat: 16.002082, lon: -24.013197, flag: require("../img/640px-Flag_of_Cape_Verde.svg.png"), capital: { name: "Praia" } },
    ...
    { code: "CF", name: "Central African Republic", lat: 6.611111, lon: 20.939444, flag: require("../img/Flag_of_the_Central_African_Republic.svg.png"), capital: { name: "Bangui" } },
    { code: "TD", name: "Chad", lat: 15.454166, lon: 18.732207, flag: require("../img/640px-Flag_of_Chad.svg.png"), capital: { name: "N'Djamena" } },
    { code: "CL", name: "Chile", lat: -35.675147, lon: -71.542969, flag: require("../img/Flag_of_Chile.svg.png"), capital: { name: "Santiago" } },
    { code: "CN", name: "China", lat: 35.86166, lon: 104.195397, flag: require("../img/Flag_of_the_People's_Republic_of_China.png"), capital: { name: "Beijing" } },
    { code: "CX", name: "Christmas Island", lat: -10.447525, lon: 105.690449 },
    { code: "CC", name: "Cocos (Keeling) Islands", lat: -12.164165, lon: 96.870956 },
    { code: "CO", name: "Colombia", lat: 4.570868, lon: -74.297333, flag: require("../img/Flag_of_Colombia.svg.png"), capital: { name: "Bogota" } },
    { code: "KM", name: "Comoros", lat: -11.875001, lon: 43.872219 },
    { code: "CG", name: "Congo", lat: -0.228021, lon: 15.827659, flag: require("../img/640px-Flag_of_Congo_Free_State.svg.png"), capital: { name: "Brazzaville" } },
    { code: "CD", name: "Congo, the Democratic Republic of the", lat: -4.038333, lon: 21.758664, flag: require("../img/640px-Flag_of_the_Democratic_Republic_of_the_Congo.svg.png"), capital: { name: "Kinshasa" } },
    { code: "CK", name: "Cook Islands", lat: -21.236736, lon: -159.777671 },
    { code: "CR", name: "Costa Rica", lat: 9.748917, lon: -83.753428, flag: require("../img/320px-Flag_of_Costa_Rica.svg.png"), capital: { name: "San Jose" } },
    { code: "CI", name: "Cote d'Ivoire", lat: 7.539989, lon: -5.54708, flag: require("../img/Flag_of_Cote_d'Ivoire.svg.png"), capital: { name: "Yamoussoukro" } },
    { code: "HR", name: "Croatia", lat: 45.1, lon: 15.2, flag: require("../img/Flag_of_Croatia.png"), capital: { name: "Zagreb" } },
    { code: "CU", name: "Cuba", lat: 21.521757, lon: -77.781167, flag: require("../img/Flag_of_Cuba.svg.png"), capital: { name: "Havana" } },
    // { code: "CW", name: "Cura\u00e7ao" },
    { code: "CY", name: "Cyprus", lat: 35.126413, lon: 33.429859, flag: require("../img/640px-Flag_of_Cyprus.svg.png"), capital: { name: "Nicosia" } },
    { code: "CZ", name: "Czech Republic", lat: 49.817492, lon: 15.472962, flag: require("../img/Flag_of_the_Czech_Republic.png"), capital: { name: "Prague" } },
    { code: "DK", name: "Denmark", lat: 56.26392, lon: 9.501785, flag: require("../img/Flag_of_Denmark.png"), capital: { name: "Copenhagen" } },
    ...
    { code: "ET", name: "Ethiopia", lat: 9.145, lon: 40.489673, flag: require("../img/Flag_of_Ethiopia.svg.png"), capital: { name: "Addis Ababa" } },
    ...
    { code: "FI", name: "Finland", lat: 61.92411, lon: 25.748151, flag: require("../img/Flag_of_Finland.png"), capital: { name: "Helsinki" } },
    { code: "FR", name: "France", lat: 46.227638, lon: 2.213749, flag: require("../img/Flag_of_France.png"), capital: { name: "Paris" } },
    ...
    { code: "GA", name: "Gabon", lat: -0.803689, lon: 11.609444, flag: require("../img/Flag_of_Gabon.svg.png"), capital: { name: "Liberville" } },
    { code: "GM", name: "Gambia, Republic of The", lat: 13.443182, lon: -15.310139, flag: require("../img/Flag_of_The_Gambia.svg.png"), capital: { name: "Banjul" } },
    { code: "GE", name: "Georgia", lat: 42.315407, lon: 43.356892, flag: require("../img/Flag_of_Georgia.png"), capital: { name: "Tbilisi" } },
    { code: "DE", name: "Germany", lat: 51.165691, lon: 10.451526, flag: require("../img/320px-Flag_of_Germany.png"), capital: { name: "Berlin" } },
    ...
    { code: "GR", name: "Greece", lat: 39.074208, lon: 21.824312, flag: require("../img/Flag_of_Greece.png"), capital: { name: "Athens" } },
    { code: "GL", name: "Greenland", lat: 71.706936, lon: -42.604303, flag: require("../img/Flag_of_Greenland.png"), capital: { name: "Nuuk" } },
    ...
    { code: "HK", name: "Hong Kong", lat: 22.396428, lon: 114.109497, flag: require("../img/Flag_of_Hong_Kong.png"), capital: { name: "Hong Kong" } },
    { code: "HU", name: "Hungary", lat: 47.162494, lon: 19.503304, flag: require("../img/Flag_of_Hungary.png"), capital: { name: "Budapest" } },
    { code: "IS", name: "Iceland", lat: 64.963051, lon: -19.020835, flag: require("../img/Flag_of_Iceland.png"), capital: { name: "Reykjavik" } },
    { code: "IN", name: "India", lat: 20.593684, lon: 78.96288, flag: require("../img/Flag_of_India.png"), capital: { name: "New Delhi" } },
    { code: "ID", name: "Indonesia", lat: -0.789275, lon: 113.921327, flag: require("../img/Flag_of_Indonesia.png"), capital: { name: "Jakarta" } },
    { code: "IR", name: "Iran", lat: 32.427908, lon: 53.688046, flag: require("../img/640px-Flag_of_Iran.png"), capital: { name: "Tehran" } },
    { code: "IQ", name: "Iraq", lat: 33.223191, lon: 43.679291, flag: require("../img/Flag_of_Iraq.png"), capital: { name: "Baghdad" } },
    { code: "IE", name: "Ireland", lat: 53.41291, lon: -8.24389, flag: require("../img/Flag_of_Ireland.png"), capital: { name: "Dublin" } },
    { code: "IM", name: "Isle of Man", lat: 54.236107, lon: -4.548056, flag: require("../img/Flag_of_the_Isle_of_Mann.png"), capital: { name: "Douglas" } },
    { code: "IL", name: "Israel", lat: 31.046051, lon: 34.851612, flag: require("../img/640px-Flag_of_Israel.png"), capital: { name: "Jerusalem" } },
    { code: "IT", name: "Italy", lat: 41.87194, lon: 12.56738, flag: require("../img/Flag_of_Italy.png"), capital: { name: "Rome" } },
    ...
    { code: "KR", name: "Korea, Republic of (South)", lat: 35.907757, lon: 127.766922, flag: require("../img/Flag_of_South_Korea.png"), capital: { name: "Pyongyang" } },
    { code: "KW", name: "Kuwait", lat: 29.31166, lon: 47.481766 },
    { code: "KG", name: "Kyrgyzstan", lat: 41.20438, lon: 74.766098, flag: require("../img/Flag_of_Kyrgyzstan.svg.png"), capital: { name: "Bishkek" } },
    { code: "LA", name: "Laos", lat: 19.85627, lon: 102.495496, flag: require("../img/Flag_of_Laos.svg.png"), capital: { name: "Vientiane" } },
    { code: "LV", name: "Latvia", lat: 56.879635, lon: 24.603189, flag: require("../img/640px-Flag_of_Latvia.png"), capital: { name: "Riga" } },
    { code: "LB", name: "Lebanon", lat: 33.854721, lon: 35.862285, flag: require("../img/640px-Flag_of_Lebanon.svg.png"), capital: { name: "Beirut" } },
    { code: "LS", name: "Lesotho", lat: -29.609988, lon: 28.233608, flag: require("../img/Flag_of_Lesotho.svg.png"), capital: { name: "Maseru" } },
    ...
    { code: "ML", name: "Mali", lat: 17.570692, lon: -3.996166, flag: require("../img/640px-Flag_of_Mali.svg.png"), capital: { name: "Bamako" } },
    { code: "MT", name: "Malta", lat: 35.937496, lon: 14.375416, flag: require("../img/Flag_of_Malta.png"), capital: { name: "Valetta" } },
    ...
    { code: "NI", name: "Nicaragua", lat: 12.865416, lon: -85.207229, flag: require("../img/256px-Flag_of_Nicaragua.svg.png"), capital: {name: "Managua"} },
    { code: "NE", name: "Niger", lat: 17.607789, lon: 8.081666, flag: require("../img/512px-Flag_of_Niger.svg.png"), capital: {name: "Niamey"} },
